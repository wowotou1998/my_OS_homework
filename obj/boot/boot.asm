...
start:
  ...
  cli                         # Disable interrupts
    7c00:	fa                   	cli    
  cld                         # String operations increment ;set the string pointer moving left or right;
    7c01:	fc                   	cld    
...
seta20.1:
  inb     $0x64,%al               # Wait for not busy ; IO instruction ; port 0x64's data ->al
    7c0a:	e4 64                	in     $0x64,%al
  testb   $0x2,%al			# test instruction will not chang source data,but will chang EFLAGS ,influencing jmp instruction;
    7c0c:	a8 02                	test   $0x2,%al
  jnz     seta20.1			# if al'content !=0 execute LOOP
...
seta20.2:
  ...
  lgdt    gdtdesc  			# gdtdesc include start_address(high 32bit) and descripters' length(low 16bit)
  ...
  movl    %eax, %cr0		#protected mode start
