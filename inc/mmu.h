...
// page table index 0x3FF = 0000 0000 00 11 1111 1111B
#define PTX(la)		((((uintptr_t) (la)) >> PTXSHIFT) & 0x0003FF)
...
#define PTE_U		0x004	// User //if the permission has no PTE_U, which represent the permission is Kernel
